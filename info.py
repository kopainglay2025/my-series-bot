...
API_ID = int(environ.get('API_ID', '7880210')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '1bb4b2ff1489cc06af37cba448c8cce9')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "5230633842:AAFwTLRfrb5G8vVy-8em9pMjAkh93MSgn2w")    # Bot token from @BotFather
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1113630298').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001254905376').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001254905376'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1001254905376'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '--1001254905376'))  # Premium logs channel id
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001254905376')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001254905376')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/mkschannel1')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1001254905376")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1001254905376")# Channels for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://msrpremium:msrpremium@cluster0.hhap4r4.mongodb.net/?retryWrites=true&w=majority")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "MKSDEMO_2") # Database name (default: cluster)
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1001254905376')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1001254905376')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/mkschannel1') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/kopainglay15') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/mkschannel1') # Update channel link for the bot
