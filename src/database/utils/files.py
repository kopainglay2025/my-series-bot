...
from umongo import Document, fields # Ensure fields is imported correctly
...
class Media(Document):
    # FIX: Use _id field directly to define the primary key as a string.
    # This avoids the 'AttributeError' caused by 'attribute='_id'' mapping.
...
async def save_file(media):
    ...
    try:
        file = Media(
            # FIX: Use _id to set the primary key value.
            _id=file_id, 
            file_ref=file_ref,
